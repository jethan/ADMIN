 ...
 *
 * @author jet (hanfajie@adirects.com)<br>
 * @since 6/29/17 4:15 PM<br>
 * <p>
 * Copyright (c) 2016，2116,北京爱投数创科技有限公司 All Rights Reserved.
 * LICENSE INFORMATION
 */
public class generatePomDependencies
{
    public static void main(String[] args) throws IOException
    {
        Element dependencys = new DOMElement("dependencies");
        File dir = new File("/home/jet/workspace/github/FHMYSQL3/WebRoot/WEB-INF/lib");
