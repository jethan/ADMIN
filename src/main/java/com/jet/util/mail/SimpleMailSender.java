  ...
  */    
    ...
    public static void main(String[] args) throws Exception
    {
        //这个类主要是设置邮件   
	     ...
	     mailInfo.setMailServerPort("25");    
	     mailInfo.setValidate(true);    
	     mailInfo.setUserName("hanfajie@xmjr.com");
	     mailInfo.setPassword("abc,FAJIE365");//您的邮箱密码
	     mailInfo.setFromAddress("hanfajie@xmjr.com");
	     mailInfo.setToAddress("136902973@qq.com");
