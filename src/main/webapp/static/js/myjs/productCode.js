 ...
 */	
	...
	function saveD(){
		...
		var fields = dname + ',jet,' + dtype + ',jet,' + dbz + ',jet,' + isQian + ',jet,' + ddefault;
	...
	function editField(value,msgIndex){
		var efieldarray = value.split(',jet,');
	...
	function appendC(value){
		...
		var fieldarray = value.split(',jet,');
	...
	function isSame(value){
		for(var i=0;i<arField.length;i++){
			var array0 = arField[i].split(',jet,')[0];
			if(array0 == value){
				return false;
			}
		}
